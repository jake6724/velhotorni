...
var sfxs: Dictionary[String, AudioStreamOggVorbis] = {
	...
	"earth_shot": preload("res://assets/audio/sfx/Earth_Shot .ogg"),
	"go": preload("res://assets/audio/sfx/Go_2.ogg"),
	"fire_select": preload("res://assets/audio/sfx/Fire_Selection.ogg"),
	"earth_select": preload("res://assets/audio/sfx/Earth_Selection.ogg"),
	...
	"earth_explosion": preload("res://assets/audio/sfx/Earth_Explosion.ogg"),
	...
	"earth_click": preload("res://assets/audio/sfx/Earth_Click.ogg"),
