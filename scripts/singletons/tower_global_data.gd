...
var tower_prices_base: Dictionary[Constants.Element, float] = {
	...
	Constants.Element.LAVA: 150,
	Constants.Element.PLASMA: 200,
	Constants.Element.STORM: 150,
	Constants.Element.LIGHTNING: 175,
	Constants.Element.ICE: 150,
	Constants.Element.FLOOD: 200,
	Constants.Element.MUD: 175,
	Constants.Element.CRYSTAL: 175,
	Constants.Element.SPIRIT: 200,
