...
var equipped_tower_1: TowerData = load("res://data/towers/tower_data_fire.tres")
var equipped_tower_2: TowerData = load("res://data/towers/tower_data_wind.tres")
var equipped_tower_3: TowerData = load("res://data/towers/tower_data_earth_crystal.tres")
var equipped_tower_4: TowerData = load("res://data/towers/tower_data_fire_lava.tres")
