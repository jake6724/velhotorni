...
func take_damage(damage_recieved: float, tower_element: Constants.Element, _execution_threshold_recieved: float = 0.0, _double_spell_mana_drop=false, damage_source: Variant=null) -> float:
	if is_alive:
