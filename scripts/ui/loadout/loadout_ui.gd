...
@onready var tab_buttons_dll: DoublyLinkedList = DoublyLinkedList.new([spell_tab_button, tower_tab_button])
@onready var _curr_tab_button: Button = tab_buttons_dll.head.value
@onready var tab_button_reset_positions: Dictionary[Button, Vector2] = {spell_tab_button: spell_tab_button.global_position, tower_tab_button: tower_tab_button.global_position}
